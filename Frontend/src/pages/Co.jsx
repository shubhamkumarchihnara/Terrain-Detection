...
const Co = () => {
   ...
   const apiCall = () => {
      ...
      axios
         .post("http://127.0.0.1:5000/api/gdal/coordinates", data)
   ...
   return (
      <>
         <div className='form' style={{ border:"1px solid blue", width: "30%", height: "600px", margin: "auto", marginTop: "130px", borderTopLeftRadius: "60px", borderBottomRightRadius: "60px", boxShadow: "2px 2px yellow, 3px 3px aqua "}}>
            ...
            <button onClick={apiCall} type='Submit' style={{ marginTop: "55%", padding: "15px", width: "100px", float: "right", marginRight: "40px", borderRadius: "10px", fontFamily: "Cambria, Cochin, Georgia, Times, 'Times New Roman', serif", letterSpacing: "2px", backgroundColor: "aqua", border: "none", cursor: "pointer", outline: "3px solid white", fontSize: "19px" }}>Submit</button>
         </div>
