...
const Analysis = () => {
  ...
  const handleFileChange = (e) => {
    ...
    axios
      .post("http://127.0.0.1:5000/tojpg", formData)
  ...
  const GdalAPI = async (e) => {
    ...
    axios
      .post("http://127.0.0.1:5000/api/gdal", formData)
      .then(function (response) {
        const output_image = response.data.image;
  ...
  return (
    <>
      ...
      >
        ...
        >
          <h2 htmlFor="name" id="a" style={{ float: "left", position: "relative", left: "60px", color: "black" }}>
